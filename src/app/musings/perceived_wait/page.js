...
export default function perceived_wait() {
    ...
    return (
      <div id="top" className="flex flex-col items-start justify-center mx-auto max-w-[648px] mt-12">
        <h1 class="mb-2 mx-6 text-tony_accent-100">Reduce perceived wait times through visual delight</h1>
        ...
        <section class="mb-8 mx-6">
            ...
            <blockquote class="mt-4 mb-2 pl-2 italic border-l-2 font-Raleway leading-loose tracking-wide text-sm text-tony_text-300 border-tony_stroke-200 quote">
            ...
            <a href="https://www.nngroup.com/articles/powers-of-10-time-scales-in-ux/" target="_blank" class="px-2 py-1 border border-tony_stroke-100 rounded-md font-Raleway text-xs text-tony_accent-100 hover hover:border-tony_stroke-200 hover:text-blue-400">
    ...
    <section class="mb-8 mx-6">
        <h2 class="mb-2">Current app launch experience of Postman</h2>
    ...
    <section class="mb-8 mx-6">
        <h2 class="mb-2">Make waiting delightful through visual magic</h2>
    ...
    <section class="mb-8 mx-6">
        <h2 class="mb-2">Design Considerations</h2>
    ...
    <section class="mb-6 mx-6">
        <h2 class="mb-2">Implementation Challenges</h2>
