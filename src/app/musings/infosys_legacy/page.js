...
export default function infosys_legacy() {
    ...
    return (
        ...
        <div id="top" className="flex flex-col items-start justify-center mx-auto max-w-[648px] mt-12">
            ...
            <h1 className="mb-2 mx-6 text-green-500">Reviving a legacy system at Infosys</h1>
            ...
            <section className="mb-8 mx-6">
                ...
                <ol className="list-decimal list-inside pl-2 space-y-2 counter">
                    ...
                    <li><strong>Employee Allocation:</strong>  Managing asset allocation, deallocation, and extensions for over 250,000 employees involves complex workflows and approvals.</li>
                    <li><strong>Software Assets:</strong> Require management of licenses, compliance, versions, and cataloging, along with allocation processes.</li>
                ...
                <ul className="list-decimal list-inside pl-2 space-y-2 counter">
                    ...
                    <li><strong>Security Department:</strong> Ensures the safety of assets on campus. Their approval is necessary for the inward and outward movement of assets.</li>
                </ul>
            </section>
            ...
            <section className="mb-8 mx-6">
                ...
                <ul className="list-decimal list-inside pl-2 space-y-2 counter">
                    ...
                    <li><strong>Software Module:</strong> This module oversees software-related processes, including License Management, Compliance, Version Control, Catalog Management, and allocation/deallocation/extension.</li>
                    <li><strong>Outwarding/Movement Module:</strong> Responsible for all campus-to-outside movements, like asset repairs, inter-campus transfers, or asset disposal. Workflows adjust based on asset type, owner, movement type, and reason, ensuring allocated assets are not inadvertently moved. Deallocation precedes any movement request for allocated assets.</li>
                </ul>
                </div>
