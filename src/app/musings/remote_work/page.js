...
export default function remote_work() {
    ...
    return (
        <div id="top" className="flex flex-col items-start justify-center mx-auto max-w-[648px] mt-12">
            <h1 class="mb-2 mx-6 text-tony_accent-100">15 Months of remote Work: A recap</h1>
            <h6 class="mb-8 mx-6 text-tony_text-300">
                7 min read . Nov 2020
            </h6>
        
            <section class="mb-8 mx-6">
                <blockquote class="pl-2 italic border-l-2 font-Raleway leading-loose tracking-wide text-sm text-tony_text-300 border-tony_stroke-200 quote">
            ...
            <section class="mb-10 mx-6">
                <h2 class="mb-2">Good Stuff</h2>
                <h4 class="mb-2">The freedom to choose location</h4>
                <p>
                ...
                <h4 class="mt-6 mb-2">Extra time at your disposal</h4>
                <p>
                ...
                <h4 class="mt-6 mb-2">Less Distraction- Enhanced productivity</h4>
                <p>
                ...
                <h4 class="mt-6 mb-2">Lower cost of living</h4>
                <p>
                ...
                <h4 class="mt-6 mb-2">More time with Family</h4>
                <p>
            ...
            <section class="mb-10 mx-6">
                ...
                <h4 class="mt-6 mb-2">Loss of social circle - the sense of belonging</h4>
                <p>
                ...
                <h4 class="mt-6 mb-2">Office Time/Personal Time- Its all the same</h4>
                <p>
                ...
                <h4 class="mt-6 mb-2">Digital Medias- The new age distraction</h4>
                <p>
                ...
                <h4 class="mt-6 mb-2">Loneliness and depression</h4>
                <p>
                ...
                <h4 class="mt-6 mb-2">No personal connection with collegues</h4>
                <p>
                ...
                <h4 class="mt-6 mb-2">Travel and work is not always a viable option</h4>
                <p>
                ...
                <h4 class="mt-6 mb-2">Other Distractions</h4>
                <p>
            ...
            <section class="mb-10 mx-6">
                ...
                <h4 class="mt-6 mb-2">Self Discipline and Timetable</h4>
                <p>
                ...
                <h4 class="mt-6 mb-2">Ownership of work</h4>
                <p>
                ...
                <h4 class="mt-6 mb-2">Clear communication</h4>
                <p>
                ...
                <h4 class="mt-6 mb-2">Set boundaries between work and personal life</h4>
                <p>
                ...
                <h4 class="mt-6 mb-2">Exercise</h4>
                <p>
                ...
                <h4 class="mt-6 mb-2">Put in that extra effort to socialise</h4>
                <p>
