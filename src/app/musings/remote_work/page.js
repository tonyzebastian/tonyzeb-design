...
export default function remote_work() {
    ...
    return (
        <div id="top" className="flex flex-col items-start justify-center mx-auto max-w-[648px] mt-12 mb-16">
            ...
            <section className="mb-10 mx-6">
                <h2 className="mb-2">Good Stuff</h2>
                <h4 className="mb-2">The freedom to choose location</h4>
                <p>
                ...
                <h4 className="mt-6 mb-2">Extra time at your disposal</h4>
                <p>
                ...
                <h4 className="mt-6 mb-2">Less Distraction- Enhanced productivity</h4>
                <p>
                ...
                <h4 className="mt-6 mb-2">Lower cost of living</h4>
                <p>
                ...
                <h4 className="mt-6 mb-2">More time with Family</h4>
                <p>
            ...
            <section className="mb-10 mx-6">
                <h2 className="mb-2">Bad Stuff</h2>
                <p>
                ...
                <h4 className="mt-6 mb-2">Loss of social circle - the sense of belonging</h4>
                <p>
                ...
                <h4 className="mt-6 mb-2">Office Time/Personal Time- Its all the same</h4>
                <p>
                ...
                <h4 className="mt-6 mb-2">Digital Medias- The new age distraction</h4>
                <p>
                ...
                <h4 className="mt-6 mb-2">Loneliness and depression</h4>
                <p>
                ...
                <h4 className="mt-6 mb-2">No personal connection with collegues</h4>
                <p>
                ...
                <h4 className="mt-6 mb-2">Travel and work is not always a viable option</h4>
                <p>
                ...
                <h4 className="mt-6 mb-2">Other Distractions</h4>
                <p>
            ...
            <section className="mb-10 mx-6">
                <h2 className="mb-4">Learnings</h2>

                <h4 className="mt-6 mb-2">Self Discipline and Timetable</h4>
                <p>
                ...
                <h4 className="mt-6 mb-2">Ownership of work</h4>
                <p>
                ...
                <h4 className="mt-6 mb-2">Clear communication</h4>
                <p>
                ...
                <h4 className="mt-6 mb-2">Set boundaries between work and personal life</h4>
                <p>
                ...
                <h4 className="mt-6 mb-2">Exercise</h4>
                <p>
                ...
                <h4 className="mt-6 mb-2">Put in that extra effort to socialise</h4>
                <p>
